      ...
      <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <div className="max-w-xl">
          ...
          <p className="mt-2 text-base text-zinc-500">
            We've received yor order and are now processing
          </p>
        ...
        <div className="mt-10 border-t border-zinc-200">
          <div className="flex flex-auto flex-col mt-10">
            ...
            <p className="mt-2 text-sm text-zinc-600">
              We at Memorycase believe that a phone case doesn't only need look
              good, but also last you for the years to come. We offer a 5-year
              print gurantee: If your case isn't of highest quality, we'll
              replace it for free.
            </p>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-x-6 border-t border-zinc-300 py-10 text-start">
            <div>
